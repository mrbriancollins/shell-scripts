...
$fpAddress = $properties.FederationPassiveAddress

if ($sslPort -eq "443"){
    $url =  ('https://' +  $hostName + $fpAddress)
}
else{
    $url =  ('https://' +  $hostName + ':' + $sslPort + $fpAddress)
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUUuvx75IKrY8siAAWCxWc48M/
# wWegghPMMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# AQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQvC1YMlbcx
# xDqOnInT4W7SMuTP2jBqBgorBgEEAYI3AgEMMVwwWqBYgFYASQBuAGYAbwByACAA
# RgBlAGQAZQByAGEAdABpAG8AbgAgAFMAZQByAHYAaQBjAGUAcwAgAFAAbwB3AGUA
# cgBTAGgAZQBsAGwAIABzAGMAcgBpAHAAdDANBgkqhkiG9w0BAQEFAASCAQBmOu4e
# xbQISqqThf8n1s9vBWLSRUUKL1RIKqfjcH3rwHYYDyTxcmNzxSjG7IkYvUIkqJSP
# jbKTte+QZBMA64ABZy7U9N5AfujudRysCpbWQKcuUeDbbHJ5oUbMp2J7++xpfIcN
# /jYz+ugeTKC/HuumsuSD9nTLmxvbEi7/izN0LVn/twZ8IPf8gX7Lx60UNqkHi/Tz
# WRRqY0FjPubm3at+9bFf9WmB2ipzZcJrigdYxiLWeqM+z5jmho0q/0WknnvwWhOQ
# RLlsL6FMp9d5bkDOLZlPCKSB9n4lQaWhBy4SL+3jUB4fy0YSLjg5ibpcJWT8co2s
# YbDhVVJhS/6lIBmVoYICCzCCAgcGCSqGSIb3DQEJBjGCAfgwggH0AgEBMHIwXjEL
...
# 9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDYxNjE5NDk0MlowIwYJKoZIhvcNAQkE
# MRYEFDysxYP9MmihMdtYM0S/vbk1VcwwMA0GCSqGSIb3DQEBAQUABIIBACX98/V6
# /8tbzb/fdxZxGeHRQQxk92OwoT9tUHQTxi9xierAUscIn7OhY1eQLCAmNW9zH/PS
# afCcYD2c9ifO35wKFABmHKpsVCU+NFCjWSO0HTPupS/SzRBo3bQQGD/TXyC9CWUj
# 8juJkVd+aq2PVO0uwRNN4os1e1LGNfYpdp++hvZbdfZSQTAFi9bCK5HNOpQuMiHN
# pZMjSc00iuR5osx660aX9PCo4YQhVqSHlcee617wIUaVh/N79C9d+dkSUV0KGqaE
# S3agcqjGQmfGZBXgycCbVvfAz5xD8SJT5rxNVYPOb51BCOHrRoLJQxr9ezG8IEG2
# W3A2roYujk7MEkY=
